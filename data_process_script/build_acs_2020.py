...
df["share_black"] = df["DP05_0038PE"]/100
...
df_out = df_out.sort_values(by=['year', 'fips']).reset_index(drop=True)

df_out.to_csv("/Users/okuran/Desktop/thesis/master_data/ctrl_var_state/state_acs_2020.csv", index=False)
