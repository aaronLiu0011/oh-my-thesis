...
income <- fread("/Users/okuran/Desktop/thesis/master_data/ctrl_var_state_2018_2025/state_percapita_income_quarterly_2018_2025.csv")

income[, fips := sprintf("%02d", as.integer(FIPS) / 1000)]
...
fwrite(income_monthly, "/Users/okuran/Desktop/thesis/master_data/ctrl_var_state_2018_2025/state_income_monthly_long.csv")
